...
channel_urls = [
    ...
    url(r'^add_integration/$', views.add_integration, name="hc-add-integration"),
    ...
    url(r'^([\w-]+)/checks_integration/$', views.webhook_checks, name="hc-webhook-checks"),
    url(r'^([\w-]+)/third_party/$', views.third_party_webhook, name="hc-new-webhook"),
    url(r'^third_party_submit/$', views.submit_webhook, name="hc-submit-webhook"),
    url(r'^third_party_delete/$', views.delete_webhook, name="hc-delete-webhook"),
    url(r'^([\w-]+)/checks/$', views.channel_checks, name="hc-channel-checks"),
    url(r'^([\w-]+)/remove/$', views.remove_channel, name="hc-remove-channel"),
    url(r'^([\w-]+)/remove_integration/$', views.remove_integration, name="hc-remove-integration"),
